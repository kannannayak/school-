...
if (isset($_POST['otp_pass'])) {
    
    $otp_pass = $_POST['otp_pass'];


    $sql2 = "SELECT * FROM  `admin`  WHERE   `otp_pass` ='$otp_pass'";
    ...
    if (mysqli_num_rows($result2) == 1) {
        ...
        header("Location: choosedashboard.php");
    } else {
                        ...
                        <form method="POST" action="" accept-charset="UTF-8" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="otp" name="otp_pass" type="text" value="" autocomplete="off">
                                </div>
