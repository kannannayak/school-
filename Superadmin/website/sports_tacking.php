        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6 mt-3 mb-3">
                    <h3>Upload image</h3>
                    <a href="add_website_img.php" class="btn btn-success">Add image</a>
                </div>
                <div class="table-responsive">
                    <table class="table mt-5 border table-secondary subcategory-table" id="myTable">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM `sports_tacking_img` ORDER BY `img_id` DESC";
                            ...
                            ?>
                                    <tr>
                                        <td><?= $count ?></td>
                                        <td><img src="../<?= $img_name ?>" alt="Slider Image" style="width: 100px; height:100px;"></td>
                                        <td>
                            ...
                            ?>
                                <tr>
                                    <td colspan="3" class="text-center">No Website Image found.</td>
                                </tr>
                            <?php
                            }
                            ?>
