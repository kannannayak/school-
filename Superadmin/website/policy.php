                ...
                <div class="portlet portlet-green">
                    ...
                    <form action="add_tools.php" method="post">
                        ...
                        <div class="portlet-body">
                            ...
                            <textarea type="text" id="textareaMax" class="form-control" rows="14" placeholder="Enter your Description..." maxlength="1000" name="privacy"><?php echo $update_datat1['privacy']; ?></textarea>
                            <br>
                            <div class="text-center">
                                <button type="submit" name="privacy_submit" class="btn btn-success">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
