            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title text-center">
                        <h1 class="mt-2">Terms and condition
                            <small></small>
                        </h1>
                    </div>
                </div>
                ...
                <div class="portlet portlet-green">
                    ...
                    <form action="add_tools.php" method="post">
                        ...
                        <div class="portlet-body">
                            ...
                            <textarea type="text" id="textareaMax" class="form-control" rows="14" placeholder="Enter your Description..." maxlength="1000" name="terms"><?php echo $update_datat1['terms']; ?></textarea>
                            <br>
                            <div class="text-center">
                                <button type="submit" name="term_submit" class="btn btn-success">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
