                ...
                <ul  class="nav navbar-nav side-nav"  id ="sidecolor" >
                    ...
                    <li class="side-user hidden-xs" >
                        ...
                        <p class="name tooltip-sidebar-logout">
                            <?php echo $_SESSION['admin_name'] ?> [<?=$_SESSION['admin_name']?>] <span class="last-name"></span> <a
                    ...
                    <li class="">   
                      ...
                      <li class="">   
                        <a class="" href="age_list">  
                         <i class="fa-solid fa-list"></i> Age List
                        </a>
                    </li>
                    <li class="">   
                        <a class="" href="isda_record">  
                           <i class="fa-solid fa-trophy"></i> ISDA Records
                        </a>
                    </li>
                      <li class="">   
                        <a class="" href="games">  
                         <i class="fa-solid fa-person-running"></i> Games List
                        </a>
                    </li>
                    </li>
                      <li class="">   
                      ...
                      <li class="">   
                        <a class="" href="Terms_condition.php">  
                         <i class="fa-solid fa-pen-to-square"></i> Terms&conditions
                        </a>
                    </li>
                    </li>
                      <li class="">   
                        <a class="" href="customer_care_details">  
                       <i class="fa-solid fa-handshake"></i> Customer 
                        </a>
                    </li>
                     <li class="">   
                     ...
                     <li class="">   
                        <a class="" href="company_details">  
                           <i class="fa-regular fa-building"></i> Company Details
                        </a>
                    </li>
                    <!-- <li class="">   
