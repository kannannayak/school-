                ...
                <div class="portlet portlet-default">
                    <div class="portlet-heading">
                        <div class="portlet-title">
                            <h4><?php echo empty($id) ? 'Add New School' : 'Edit School'; ?></h4>
                        </div>
                                ...
                                <form method="post" action="action/schl" enctype="multipart/form-data">
                                    <div class="col-lg-12">
                                        <div class="col-lg-6">
                                            ...
                                            <input required type="text" name="school_name" class="form-control" placeholder="School Name" value="<?php echo htmlspecialchars($school_name); ?>"> 
                                        </div>
                                        <div class="col-lg-6">
                                            <label>School Location</label>
                                            <input required type="text" name="school_location" class="form-control" placeholder="Location" value="<?php echo htmlspecialchars($school_location); ?>">
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Login Email</label>
                                            <input required type="text" name="school_email" class="form-control" placeholder="email" value="<?php echo htmlspecialchars($school_email); ?>">
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Password</label>
                                            <input required type="text" name="school_pass" class="form-control" placeholder="password" value="<?php echo htmlspecialchars($school_pass); ?>">
