...
$update_cat_query = "SELECT `company_details` FROM `info`";
                    ...
                    <div class="portlet portlet-default">
                        ...
                        <form action="" method="post">
                            <div class="portlet-body">
                                <h4>Content</h4>
                                <textarea id="editor1" class="form-control" rows="14" placeholder="Enter your Description..." maxlength="1000" name="company_details"><?php echo htmlspecialchars($update_datat1['company_details']); ?></textarea>
                                <br>
                                <div class="">
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `info` SET `company_details`='$company_details'";
