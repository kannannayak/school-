...
if (!empty($data->api_key)) {
    ...
    if ($itemCount > 0) {
        ...
        if ($itemCount > 0) {
            ...
            echo json_encode(array("status" => true, "message" => "Company Detail", "Data" => $companyDetails));
        } else {
            http_response_code(400);
            echo json_encode(array("status" => false, "message" => "No Company Detail Found"));
        }
    } else {
