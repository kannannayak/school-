...
if (!empty($data->api_key)) {
    ...
    if ($itemCount > 0) {
        ...
        if ($itemCount > 0) {
            ...
            echo json_encode(array("status" => "Success", "message" => "tournament list", "Data" => $terms_cons));
        } else {
            http_response_code(400);
            echo json_encode(array("status" => "Failed", "message" => "No tournament Found"));
        }
    } else {
