            ...
            <div class="col-lg-12">
                ...
                <table id="data_table" class="display dataTable table table-striped table-bordered table-hover table-green">
                    ...
                    <tbody id="data_table">
                        ...
                        $sql = "SELECT rec.*, us.*, game.game_type_name,sch.school_name,tri.trainer_name,gen.gender_name,tri.tlog_id 
                        ...
                        WHERE rec.total_time IS NOT NULL AND sch.school_id =  $school_id";
